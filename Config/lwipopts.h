...
#define LWIP_SOCKET                     1                           // LWIP_SOCKET==1: Enable Socket API (require to use sockets.c)
...
#define LWIP_ICMP                       0                           // LWIP_ICMP==1:   Turn on ICMP module.
...
#define LWIP_ALTCP                      0                           // LWIP_ALTCP==1:  Turn on the altcp API.    altcp is an abstraction layer that prevents applications linking against the tcp.h functions
...
#define PBUF_POOL_SIZE                  16 //LWIP_MEM_ALIGN_SIZE(TCP_MSS + 40 + PBUF_LINK_ENCAPSULATION_HLEN + PBUF_LINK_HLEN)
